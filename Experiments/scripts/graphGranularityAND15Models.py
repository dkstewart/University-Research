...
csvfileFault= os.path.join(userhome, 'git/dkstewart/University-Research/Experiments', 'granularityDataComp.csv')
...
plt.scatter(x2, y2, label= "Granularity Algorithm Model Analysis", color= "red", marker= "x", s=30) 
