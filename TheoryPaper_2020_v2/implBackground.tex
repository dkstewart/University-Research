...
\danielle{Example sensor component}
...
An example of a fault definition on the temperature sensor for the PWR is shown in Figure~\ref{fig:tempSensorFault}.
...
The fault is attached to the \texttt{High\_Temp\_Indicator} output and has a probability of occurrence of $1.0 \times 10^{-5}$. The behavior of the output when the fault is active is to report high temperature. 