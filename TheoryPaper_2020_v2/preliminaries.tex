...
To implement the formalism described in Section~\ref{sec:formalism}, we needed to compute minimal cut sets per layer of compositional analysis, transform them into their related Boolean formula, and compose them compositionally. \danielle{Introduce minimal ivcs, Show diagram of breaking each proof path, provide the formalization of ivcs and link them to MUSs and minimal cut sets, implBackground, algorithm}
