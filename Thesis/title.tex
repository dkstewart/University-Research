...
\title{\textbf{Behavioral Fault Analysis and the Composition of Fault Forests}}
...
\submissionmonth{January} % defaults to current month.
\submissionyear{2021} % defaults to current year.
