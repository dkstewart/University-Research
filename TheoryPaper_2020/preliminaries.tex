...
\danielle{Completely cut inductive and SAT descriptions - this paragraph is taken from FMCAD paper. The 2016 paper has more info in induction; I can extend this with that in mind if necessary. Just let me know.}
...
\danielle{Okay, it seems to me that I *have* to bridge the gap somehow between transition systems and IVCs and constraint systems with their MUSs/MCSs/hitting sets. Without some discussion on how this can occur, it will make little sense to a reader that isn't familiar. So, I placed this conversation in prelim and made them into definitions for later reference.}
