...
\author{Danielle Stewart\inst{1} \and Mats Heimdahl\inst{1} \and Michael Whalen\inst{1} \and 
Jing (Janet) Liu\inst{2} \and Darren Cofer\inst{2}}

\institute{University of Minnesota, Minneapolis, MN, USA,\\
\email{\{dkstewar, heimdahl, mwwhalen\}@umn.edu} \and Collins Aerospace - Trusted Systems, Cedar Rapids, IO, USA,\\
